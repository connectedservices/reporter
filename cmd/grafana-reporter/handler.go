...
import (
	...
	"github.com/connectedservices/reporter/grafana"
	"github.com/connectedservices/reporter/report"
...
func RegisterHandlers(router *mux.Router, reportServerV4, reportServerV5 ServeReportHandler) {
	...
	router.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		fmt.Fprintf(w, "This is grafana-reporter. \nThe API endpoints are documented here: https://github.com/connectedservices/reporter#endpoint.")
	})
